...
public class Log
{
    ...
    /**
     * Performs the actual logging. Default implementation logs to System.out. Extended and use {@link Log#logger} set to handle logging differently.
     */
    ...
    static public class MZLog extends Logger
    {
